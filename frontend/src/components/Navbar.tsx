    ...
    <div className="flex z-10 absolute flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-8">
      <TooltipProvider>
        ...
        >
                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      "size-10 sm:size-12 rounded-full text-white"
                    )}
                  >
          ...
          <div className="text-white leading-none tracking-normal px-2 sm:px-4">
            <SparklesText
              sparklesCount={5}
              text="Welcome To FinGyaan"
              className="text-xs sm:text-sm lg:text-base"
            />
          </div>
          <Separator
            orientation="vertical"
            className="h-full py-2 bg-zinc-600"
          />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div
                    ...
                    className={cn(
                      buttonVariants({ variant: "ghost", size: "icon" }),
                      "size-10 sm:size-12 rounded-full text-white cursor-pointer"
                    )}
                  >
                    <btns.icon className="size-3 sm:size-4" />
                  </div>
                </TooltipTrigger>
                <TooltipContent>
                  <p>{name}</p>
